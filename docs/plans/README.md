...
| 4 | `2026-08-04-04-telemetry-governance.md` | Executable after ruling | BLOCKED BY 3 AND R-004 | Retention and IP-rate-limit ruling recorded | Rate, dedupe, retention, privacy tests |
...
| C-007 storage deletion | PARTIALLY RESOLVED | Synchronous object cleanup exists; retryable workflow semantics remain in Plan 3 |
| C-008 active-worker deletion fence | OPEN | Plan 3 |
| C-009 segment inventory binding | OPEN | Plan 3 |
| C-010 telemetry governance | OPEN | Plan 4 after owner ruling R-004 |
